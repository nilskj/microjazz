...
function Protracker() {
    ...
    // effect jumptables
    this.effects_t0 = new Array(this.effect_t0_0, this.effect_t0_1, this.effect_t0_2, this.effect_t0_3, this.effect_t0_4, this.effect_t0_5, this.effect_t0_6, this.effect_t0_7, this.effect_t0_8, this.effect_t0_9, this.effect_t0_a, this.effect_t0_b, this.effect_t0_c, this.effect_t0_d, this.effect_t0_e, this.effect_t0_f);
    this.effects_t0_e = new Array(this.effect_t0_e0, this.effect_t0_e1, this.effect_t0_e2, this.effect_t0_e3, this.effect_t0_e4, this.effect_t0_e5, this.effect_t0_e6, this.effect_t0_e7, this.effect_t0_e8, this.effect_t0_e9, this.effect_t0_ea, this.effect_t0_eb, this.effect_t0_ec, this.effect_t0_ed, this.effect_t0_ee, this.effect_t0_ef);
    this.effects_t1 = new Array(this.effect_t1_0, this.effect_t1_1, this.effect_t1_2, this.effect_t1_3, this.effect_t1_4, this.effect_t1_5, this.effect_t1_6, this.effect_t1_7, this.effect_t1_8, this.effect_t1_9, this.effect_t1_a, this.effect_t1_b, this.effect_t1_c, this.effect_t1_d, this.effect_t1_e, this.effect_t1_f);
    this.effects_t1_e = new Array(this.effect_t1_e0, this.effect_t1_e1, this.effect_t1_e2, this.effect_t1_e3, this.effect_t1_e4, this.effect_t1_e5, this.effect_t1_e6, this.effect_t1_e7, this.effect_t1_e8, this.effect_t1_e9, this.effect_t1_ea, this.effect_t1_eb, this.effect_t1_ec, this.effect_t1_ed, this.effect_t1_ee, this.effect_t1_ef);
}
exports.default = Protracker;
// clear song data
...
Protracker.prototype.parse = function (buffer) {
    ...
    for (var i_1 = 0; i_1 < 4; i_1++)
        this.signature += String.fromCharCode(buffer[1080 + i_1]);
    ...
    this.chvu = new Array();
    for (var i_2 = 0; i_2 < this.channels; i_2++)
        this.chvu[i_2] = 0.0;
    i = 0;
    while (buffer[i] && i < 20)
        this.title = this.title + String.fromCharCode(buffer[i++]);
    for (var i_3 = 0; i_3 < this.samples; i_3++) {
        var st = 20 + i_3 * 30;
        j = 0;
        while (buffer[st + j] && j < 22) {
            this.sample[i_3].name += buffer[st + j] > 0x1f && buffer[st + j] < 0x7f ? String.fromCharCode(buffer[st + j]) : " ";
            j++;
        }
        this.sample[i_3].length = 2 * (buffer[st + 22] * 256 + buffer[st + 23]);
        this.sample[i_3].finetune = buffer[st + 24];
        if (this.sample[i_3].finetune > 7)
            this.sample[i_3].finetune = this.sample[i_3].finetune - 16;
        this.sample[i_3].volume = buffer[st + 25];
        this.sample[i_3].loopstart = 2 * (buffer[st + 26] * 256 + buffer[st + 27]);
        this.sample[i_3].looplength = 2 * (buffer[st + 28] * 256 + buffer[st + 29]);
        if (this.sample[i_3].looplength == 2)
            this.sample[i_3].looplength = 0;
        if (this.sample[i_3].loopstart > this.sample[i_3].length) {
            this.sample[i_3].loopstart = 0;
            this.sample[i_3].looplength = 0;
        }
    }
    ...
    for (var i_4 = 0; i_4 < 128; i_4++) {
        this.patterntable[i_4] = buffer[952 + i_4];
        if (this.patterntable[i_4] > this.patterns)
            this.patterns = this.patterntable[i_4];
    }
    this.patterns += 1;
    ...
    this.note = new Array();
    this.pattern_unpack = new Array();
    for (var i_5 = 0; i_5 < this.patterns; i_5++) {
        this.pattern[i_5] = new Uint8Array(patlen);
        this.note[i_5] = new Uint8Array(this.channels * 64);
        this.pattern_unpack[i_5] = new Uint8Array(this.channels * 64 * 5);
        for (j = 0; j < patlen; j++)
            this.pattern[i_5][j] = buffer[1084 + i_5 * patlen + j];
        for (j = 0; j < 64; j++)
            for (c = 0; c < this.channels; c++) {
                this.note[i_5][j * this.channels + c] = 0;
                var n = ((this.pattern[i_5][j * 4 * this.channels + c * 4] & 0x0f) << 8) |
                    this.pattern[i_5][j * 4 * this.channels + c * 4 + 1];
                for (var np = 0; np < this.baseperiodtable.length; np++)
                    if (n == this.baseperiodtable[np])
                        this.note[i_5][j * this.channels + c] = np;
            }
        for (j = 0; j < 64; j++) {
            for (c = 0; c < this.channels; c++) {
                var pp = j * 4 * this.channels + c * 4;
                var ppu = j * 5 * this.channels + c * 5;
                var n = ((this.pattern[i_5][pp] & 0x0f) << 8) | this.pattern[i_5][pp + 1];
                if (n) {
                    n = this.note[i_5][j * this.channels + c];
                    n = n % 12 | ((Math.floor(n / 12) + 2) << 4);
                }
                this.pattern_unpack[i_5][ppu + 0] = n ? n : 255;
                this.pattern_unpack[i_5][ppu + 1] = (this.pattern[i_5][pp + 0] & 0xf0) | (this.pattern[i_5][pp + 2] >> 4);
                this.pattern_unpack[i_5][ppu + 2] = 255;
                this.pattern_unpack[i_5][ppu + 3] = this.pattern[i_5][pp + 2] & 0x0f;
                this.pattern_unpack[i_5][ppu + 4] = this.pattern[i_5][pp + 3];
            }
        }
    }
    var sst = 1084 + this.patterns * patlen;
    for (var i_6 = 0; i_6 < this.samples; i_6++) {
        this.sample[i_6].data = new Float32Array(this.sample[i_6].length);
        for (j = 0; j < this.sample[i_6].length; j++) {
            var q = buffer[sst + j];
            if (q < 128) {
                q = q / 128.0;
            }
            ...
            this.sample[i_6].data[j] = q;
        }
        sst += this.sample[i_6].length;
    }
    ...
    for (var i_7 = 0; i_7 < this.channels; i_7++)
        this.chvu[i_7] = 0.0;
    return true;
};
// advance player
            ...
            for (var ch = 0; ch < mod.channels; ch++) {
                ...
                if (mod.channel[ch].flags & 2) {
                    ...
                    if (mod.channel[ch].period >= 120)
                        mod.channel[ch].semitone =
                            mod.baseperiodtable[mod.channel[ch].note] - mod.baseperiodtable[mod.channel[ch].note + 1];
                }
                ...
                if ((mod.channel[ch].flags & 1 || mod.flags & 2) && mod.channel[ch].voiceperiod)
                    mod.channel[ch].samplespeed =
                        ((7093789.2 / (mod.channel[ch].voiceperiod * 2)) *
                            mod.finetunetable[mod.sample[mod.channel[ch].sample].finetune + 8]) /
                            mod.samplerate;
                ...
                if (mod.channel[ch].noteon) {
                    if (mod.sample[mod.channel[ch].sample].length > mod.channel[ch].samplepos)
                        f =
                            (mod.sample[mod.channel[ch].sample].data[Math.floor(mod.channel[ch].samplepos)] *
                ...
                if (mod.channel[ch].noteon) {
                    if (mod.sample[mod.channel[ch].sample].loopstart || mod.sample[mod.channel[ch].sample].looplength) {
                        if (mod.channel[ch].samplepos >=
                            mod.sample[mod.channel[ch].sample].loopstart + mod.sample[mod.channel[ch].sample].looplength) {
...
//
Protracker.prototype.effect_t0_0 = function (mod, ch) {
    // 0 arpeggio
    mod.channel[ch].arpeggio = mod.channel[ch].data;
};
Protracker.prototype.effect_t0_1 = function (mod, ch) {
    // 1 slide up
    if (mod.channel[ch].data)
        mod.channel[ch].slidespeed = mod.channel[ch].data;
};
Protracker.prototype.effect_t0_2 = function (mod, ch) {
    // 2 slide down
    if (mod.channel[ch].data)
        mod.channel[ch].slidespeed = mod.channel[ch].data;
};
Protracker.prototype.effect_t0_3 = function (mod, ch) {
    // 3 slide to note
    if (mod.channel[ch].data)
        mod.channel[ch].slidetospeed = mod.channel[ch].data;
};
Protracker.prototype.effect_t0_4 = function (mod, ch) {
    // 4 vibrato
...
Protracker.prototype.effect_t0_5 = function (mod, ch) {
    // 5
};
Protracker.prototype.effect_t0_6 = function (mod, ch) {
    // 6
};
Protracker.prototype.effect_t0_7 = function (mod, ch) {
    // 7
};
Protracker.prototype.effect_t0_8 = function (mod, ch) {
    // 8 unused, used for syncing
    mod.syncqueue.unshift(mod.channel[ch].data & 0x0f);
};
Protracker.prototype.effect_t0_9 = function (mod, ch) {
    // 9 set sample offset
    mod.channel[ch].samplepos = mod.channel[ch].data * 256;
};
Protracker.prototype.effect_t0_a = function (mod, ch) {
    // a
};
Protracker.prototype.effect_t0_b = function (mod, ch) {
    // b pattern jump
    mod.breakrow = 0;
    mod.patternjump = mod.channel[ch].data;
    mod.flags |= 16;
};
Protracker.prototype.effect_t0_c = function (mod, ch) {
    // c set volume
    mod.channel[ch].volume = mod.channel[ch].data;
};
Protracker.prototype.effect_t0_d = function (mod, ch) {
    // d pattern break
...
Protracker.prototype.effect_t0_e = function (mod, ch) {
    // e
    var i = (mod.channel[ch].data & 0xf0) >> 4;
    mod.effects_t0_e[i](mod, ch);
};
Protracker.prototype.effect_t0_f = function (mod, ch) {
    // f set speed
...
//
Protracker.prototype.effect_t0_e0 = function (mod, ch) {
    // e0 filter on/off
    if (mod.channels > 4)
...
Protracker.prototype.effect_t0_e3 = function (mod, ch) {
    // e3 set glissando
};
Protracker.prototype.effect_t0_e4 = function (mod, ch) {
    // e4 set vibrato waveform
    mod.channel[ch].vibratowave = mod.channel[ch].data & 0x07;
};
Protracker.prototype.effect_t0_e5 = function (mod, ch) {
    // e5 set finetune
};
Protracker.prototype.effect_t0_e6 = function (mod, ch) {
    // e6 loop pattern
...
Protracker.prototype.effect_t0_e7 = function (mod, ch) {
    // e7
};
Protracker.prototype.effect_t0_e8 = function (mod, ch) {
    // e8, use for syncing
    mod.syncqueue.unshift(mod.channel[ch].data & 0x0f);
};
Protracker.prototype.effect_t0_e9 = function (mod, ch) {
    // e9
};
Protracker.prototype.effect_t0_ea = function (mod, ch) {
    // ea fine volslide up
    mod.channel[ch].volume += mod.channel[ch].data & 0x0f;
    if (mod.channel[ch].volume > 64)
        mod.channel[ch].volume = 64;
};
Protracker.prototype.effect_t0_eb = function (mod, ch) {
    // eb fine volslide down
    mod.channel[ch].volume -= mod.channel[ch].data & 0x0f;
    if (mod.channel[ch].volume < 0)
        mod.channel[ch].volume = 0;
};
Protracker.prototype.effect_t0_ec = function (mod, ch) {
    // ec
};
Protracker.prototype.effect_t0_ed = function (mod, ch) {
    // ed delay sample
...
Protracker.prototype.effect_t0_ee = function (mod, ch) {
    // ee delay pattern
    mod.patterndelay = mod.channel[ch].data & 0x0f;
    mod.patternwait = 0;
};
Protracker.prototype.effect_t0_ef = function (mod, ch) {
    // ef
};
//
// tick 1+ effect functions
//
Protracker.prototype.effect_t1_0 = function (mod, ch) {
    // 0 arpeggio
    if (mod.channel[ch].data) {
...
Protracker.prototype.effect_t1_1 = function (mod, ch) {
    // 1 slide up
...
Protracker.prototype.effect_t1_2 = function (mod, ch) {
    // 2 slide down
    mod.channel[ch].period += mod.channel[ch].slidespeed;
    if (mod.channel[ch].period > 856)
        mod.channel[ch].period = 856;
...
Protracker.prototype.effect_t1_3 = function (mod, ch) {
    // 3 slide to note
...
Protracker.prototype.effect_t1_4 = function (mod, ch) {
    // 4 vibrato
...
Protracker.prototype.effect_t1_5 = function (mod, ch) {
    // 5 volslide + slide to note
    mod.effect_t1_3(mod, ch); // slide to note
    mod.effect_t1_a(mod, ch); // volslide
};
Protracker.prototype.effect_t1_6 = function (mod, ch) {
    // 6 volslide + vibrato
    mod.effect_t1_4(mod, ch); // vibrato
    mod.effect_t1_a(mod, ch); // volslide
};
Protracker.prototype.effect_t1_7 = function (mod, ch) {
    // 7
};
Protracker.prototype.effect_t1_8 = function (mod, ch) {
    // 8 unused
};
Protracker.prototype.effect_t1_9 = function (mod, ch) {
    // 9 set sample offset
};
Protracker.prototype.effect_t1_a = function (mod, ch) {
    // a volume slide
    if (!(mod.channel[ch].data & 0x0f)) {
        // y is zero, slide up
...
Protracker.prototype.effect_t1_b = function (mod, ch) {
    // b pattern jump
};
Protracker.prototype.effect_t1_c = function (mod, ch) {
    // c set volume
};
Protracker.prototype.effect_t1_d = function (mod, ch) {
    // d pattern break
};
Protracker.prototype.effect_t1_e = function (mod, ch) {
    // e
    var i = (mod.channel[ch].data & 0xf0) >> 4;
    mod.effects_t1_e[i](mod, ch);
};
Protracker.prototype.effect_t1_f = function (mod, ch) {
    // f
};
//
// tick 1+ effect e functions
//
Protracker.prototype.effect_t1_e0 = function (mod, ch) {
    // e0
};
Protracker.prototype.effect_t1_e1 = function (mod, ch) {
    // e1
};
Protracker.prototype.effect_t1_e2 = function (mod, ch) {
    // e2
};
Protracker.prototype.effect_t1_e3 = function (mod, ch) {
    // e3
};
Protracker.prototype.effect_t1_e4 = function (mod, ch) {
    // e4
};
Protracker.prototype.effect_t1_e5 = function (mod, ch) {
    // e5
};
Protracker.prototype.effect_t1_e6 = function (mod, ch) {
    // e6
};
Protracker.prototype.effect_t1_e7 = function (mod, ch) {
    // e7
};
Protracker.prototype.effect_t1_e8 = function (mod, ch) {
    // e8
};
Protracker.prototype.effect_t1_e9 = function (mod, ch) {
    // e9 retrig sample
    if (mod.tick % (mod.channel[ch].data & 0x0f) == 0)
        mod.channel[ch].samplepos = 0;
};
Protracker.prototype.effect_t1_ea = function (mod, ch) {
    // ea
};
Protracker.prototype.effect_t1_eb = function (mod, ch) {
    // eb
};
Protracker.prototype.effect_t1_ec = function (mod, ch) {
    // ec cut sample
    if (mod.tick == (mod.channel[ch].data & 0x0f))
        mod.channel[ch].volume = 0;
};
Protracker.prototype.effect_t1_ed = function (mod, ch) {
    // ed delay sample
    mod.effect_t0_ed(mod, ch);
};
Protracker.prototype.effect_t1_ee = function (mod, ch) {
    // ee
};
Protracker.prototype.effect_t1_ef = function (mod, ch) {
    // ef
};
